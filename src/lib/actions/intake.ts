  ...
  try {
    const [client] = await db
      ...
      .values({
        ...
        commPreference: parsed.commPreference ?? null,
    ...
    await db.insert(clientIntake).values({
      ...
      splitPreference: parsed.splitPreference ?? null,
